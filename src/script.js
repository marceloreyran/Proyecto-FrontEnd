...
const listaCursos = document.querySelector('#lista__cursos');
const contenedorCarrito = document.querySelector('#lista__carrito tbody');
const vaciarCarritoBtn = document.querySelector('#vaciar__carrito'); 
...
function eliminarCurso(e) {
     e.preventDefault();
     if(e.target.classList.contains('borrar__curso') ) {
...
function carritoHTML() {
     ...
     articulosCarrito.forEach(curso => {
          ...
          row.innerHTML = `
               ...
               <td>
                    <a href="#" class="borrar__curso" data-id="${curso.id}">X</a>
               </td>
          `;
